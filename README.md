...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ltk2h1k.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ltk2h1k.containers.anotherwebservice.com/
...
```
git clone git@github.com:lvllaby/container-ltk2h1k.git
cd container-ltk2h1k
```
...
```
docker attach container-ltk2h1k
```
